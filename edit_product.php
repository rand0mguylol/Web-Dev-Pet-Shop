          ...
          <?php else: ?>
            <form class="row g-3 " id="register-form" action="./controller/register_user.php" method="POST">
              ...
              <div class="col-md-12">
                  ...
                  <textarea class="form-control" id="exampleFormControlTextarea1" rows="25"><?php echo  htmlspecialchars(str_replace('\n', "\n", $itemArray["description"]))?></textarea>
              </div>
              <div class="col-md-12">
                  <label for="inputEmail" class="form-label">Brand</label>
                  <input type="text" class="form-control" id="inputEmail" placeholder="Brand" name="email"  value = "<?php echo $itemArray["brand"];?>" required>
              </div>
              <div class="col-md-12">
                  <label for="inputEmail" class="form-label">Weight</label>
                  <input type="text" class="form-control" id="inputEmail" placeholder="Weight" name="email" value = "<?php echo $itemArray["weight"];?>" required>
              </div>
              <div class="col-md-12">
                  <label for="inputEmail" class="form-label">Warranty Period</label>
                  <input type="text" class="form-control" id="inputEmail" placeholder="Warranty Period" name="email" value = "<?php echo $itemArray["warrantyPeriod"];?>" required>
              </div>
              <div class="col-md-12">
                  <label for="inputEmail" class="form-label">Product Dimensions</label>
                  <input type="text" class="form-control" id="inputEmail" placeholder="Product Dimensions" name="email"  value = "<?php echo $itemArray["productDimensions"];?>"required>
              </div>
          <?php endif; ?>
