        ...
        <div>
          <form action="" method="POST">
            <div class=" item-quantity-section mb-5">
              ...
              <input type="number" class="text-center rounded" name="item_quantity" min="1" value="1" class="d-block" <?php if (in_array($itemInfo['itemSubInfo']['category'], $petArray)) {echo 'readonly';} ?>>
            </div>
            <div>
